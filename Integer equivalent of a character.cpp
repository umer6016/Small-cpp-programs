...
int main(){
/*2.27 (Integer Equivalent of a Character) Here is a peek
...
//static casting the character taken from the user and printing it
std::cout<<"The character set integer value corresponding to the character is "<<static_cast<int>(input); 
}